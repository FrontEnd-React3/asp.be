...
export const Daata = [
  ...
  },
  {
    ...
    body: "Mobile phones are everyone's pocket computer. The software for those devices can not be a smaller version of the computer application. Mobile phones have dynamic keyboard that are different depending on the information you have to type. Are you introducing a date or rather an The world is taking notice.",
    image: mobile,
    imgMod: phone,
  },
];
